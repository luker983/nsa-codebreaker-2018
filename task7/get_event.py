...
#                ransoms.append(line.rstrip())
        ...
        print(current) 
        authfilter = escrow_contract.events.DecryptCallbackEvent.createFilter(fromBlock=current - 500, toBlock=current)
...
#            for x in range(0, 60):
#                print(datetime.datetime.utcfromtimestamp(timestamp - x), "GMT")
